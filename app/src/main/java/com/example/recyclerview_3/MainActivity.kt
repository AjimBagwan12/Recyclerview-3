...
class MainActivity : AppCompatActivity() {
    ...
    private fun initViews() {
        ...
        recyclerTasks = findViewById(R.id.recyclerTask)
    ...
    private fun initTasks() {
        ...
        tasks.add(Task(1, "Pay bills", "12-09-2023", R.mipmap.ic_launcher_round, false))
        tasks.add(Task(2, "Finish the assignments", "12-09-2023", R.mipmap.ic_launcher_round, true))
        tasks.add(Task(3, "Call office", "1-11-2023", R.mipmap.ic_launcher_round, false))
        tasks.add(Task(4, "Email work plan", "30-09-2023", R.mipmap.ic_launcher, true))
        tasks.add(Task(5, "Plan the party", "16-09-2023", R.mipmap.ic_launcher_round, false))
        tasks.add(Task(6, "XYZ something", "21-09-2023", R.mipmap.ic_launcher_round, false))
        tasks.add(Task(7, "Something xyz", "12-10-2023", R.mipmap.ic_launcher_round, true))
    }
}
